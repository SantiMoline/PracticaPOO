...
public class Ej11 {
    public static void main(String[] args) {
        ...
        System.out.println("La fecha ingresada es la siguiente: " + fecha.toString());
        System.out.println("La fecha ingresada es la siguiente: " + hoy.toString());
        System.out.println("La diferencia en años entre las fechas es: " + Math.abs(hoy.getYear() - fecha.getYear()));
        scan.close();
    }
}
